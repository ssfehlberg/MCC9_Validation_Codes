#define bnb_beta1_rolling_cxx
#include "bnb_beta1_rolling.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void bnb_beta1_rolling::Loop()
{
  TFile *tfile = new TFile("bnb_beta1_rolling_histos.root","RECREATE");
