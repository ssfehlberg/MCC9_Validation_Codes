...
// Tue Sep 25 10:48:22 2018 by ROOT version 6.06/08
// from TTree tree/
// found on file: /uboone/data/users/renlu23/MCC9/Sep24_2018/MC_beta1.root
//////////////////////////////////////////////////////////
...
#ifdef MC_beta1_cxx
MC_beta1::MC_beta1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/renlu23/MCC9/Sep24_2018/MC_beta1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/renlu23/MCC9/Sep24_2018/MC_beta1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/renlu23/MCC9/Sep24_2018/MC_beta1.root:/UBXSec");
...
Int_t MC_beta1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_beta1::LoadTree(Long64_t entry)
{
...
void MC_beta1::Show(Long64_t entry)
{
...
Int_t MC_beta1::Cut(Long64_t entry)
{
