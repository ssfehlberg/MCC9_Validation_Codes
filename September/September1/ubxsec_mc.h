...
// Wed Sep  5 14:16:58 2018 by ROOT version 6.06/08
// from TTree tree/
// found on file: ubxsec_mc_default.root
//////////////////////////////////////////////////////////
...
#ifdef ubxsec_mc_cxx
ubxsec_mc::ubxsec_mc(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ubxsec_mc_default.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ubxsec_mc_default.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ubxsec_mc_default.root:/UBXSec");
...
Int_t ubxsec_mc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ubxsec_mc::LoadTree(Long64_t entry)
{
...
void ubxsec_mc::Init(TTree *tree)
{
...
void ubxsec_mc::Show(Long64_t entry)
{
...
Int_t ubxsec_mc::Cut(Long64_t entry)
{
