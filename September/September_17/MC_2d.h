...
// Thu Sep 20 10:03:06 2018 by ROOT version 6.06/08
// from TTree tree/
// found on file: /uboone/data/users/renlu23/MCC9/Sep17_2018/MC_2d.root
//////////////////////////////////////////////////////////
...
#ifdef MC_2d_cxx
MC_2d::MC_2d(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/renlu23/MCC9/Sep17_2018/MC_2d.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/renlu23/MCC9/Sep17_2018/MC_2d.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/renlu23/MCC9/Sep17_2018/MC_2d.root:/UBXSec");
...
Int_t MC_2d::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_2d::LoadTree(Long64_t entry)
{
...
void MC_2d::Show(Long64_t entry)
{
...
Int_t MC_2d::Cut(Long64_t entry)
{
