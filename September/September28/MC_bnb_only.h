...
// Fri Sep 28 13:24:28 2018 by ROOT version 6.06/08
// from TTree tree/
// found on file: /uboone/data/users/renlu23/MCC9/Sep24_2018/MC_bnb_only.root
//////////////////////////////////////////////////////////

#ifndef MC_bnb_only_h
#define MC_bnb_only_h
...
#ifdef MC_bnb_only_cxx
MC_bnb_only::MC_bnb_only(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/renlu23/MCC9/Sep24_2018/MC_bnb_only.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/renlu23/MCC9/Sep24_2018/MC_bnb_only.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/renlu23/MCC9/Sep24_2018/MC_bnb_only.root:/UBXSec");
...
MC_bnb_only::~MC_bnb_only()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MC_bnb_only::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_bnb_only::LoadTree(Long64_t entry)
{
...
void MC_bnb_only::Init(TTree *tree)
{
...
void MC_bnb_only::Show(Long64_t entry)
{
...
Int_t MC_bnb_only::Cut(Long64_t entry)
{
