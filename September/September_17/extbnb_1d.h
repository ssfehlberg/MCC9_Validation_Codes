...
// Thu Sep 20 08:34:12 2018 by ROOT version 6.06/08
// from TTree tree/
// found on file: /uboone/data/users/renlu23/MCC9/Sep17_2018/extbnb_1d.root
//////////////////////////////////////////////////////////
...
#ifdef extbnb_1d_cxx
extbnb_1d::extbnb_1d(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/renlu23/MCC9/Sep17_2018/extbnb_1d.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/renlu23/MCC9/Sep17_2018/extbnb_1d.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/renlu23/MCC9/Sep17_2018/extbnb_1d.root:/UBXSec");
...
Int_t extbnb_1d::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t extbnb_1d::LoadTree(Long64_t entry)
{
...
void extbnb_1d::Init(TTree *tree)
{
...
void extbnb_1d::Show(Long64_t entry)
{
...
Int_t extbnb_1d::Cut(Long64_t entry)
{
