...

{
  ...
  //TH1D *h10_1 = (TH1D*)f2->Get("h_muon_momentum_bnb");
  ...
  legend_1->AddEntry(h1_1,"on - offbeam");
  ...
  legend_2->AddEntry(h2_1,"on - beamoff");
  ...
  legend_3->AddEntry(h3_1,"on - offbeam");
  ...
  // h_vtxx_d->Draw("eSAME");
  // h_vtxx_d->SetMarkerColor(kGreen);
  //h_vtxx_d->SetMarkerStyle(21);
  ...
  legend_4->AddEntry(h4,"MC");
  //legend_4->AddEntry(h4_1,"on-offbeam");
  ...
  legend_5->AddEntry(h5_1,"on-offbeam");
  ...
  legend_6->AddEntry(h6_1,"on - offbeam");
  ...
  legend_7->AddEntry(h7_1,"on-offbeam");
  ...
  legend_8->AddEntry(h8_1,"on-offbeam");
  ...
  h9->SetAxisRange(0., 7000,"Y");

  auto legend_9 = new TLegend(0.8,0.8,0.9,0.9);
  legend_9->AddEntry(h9,"MC");
  legend_9->AddEntry(h9_1,"on-offbeam");
  //legend_9->AddEntry(h9_2,"EXT");
  legend_9->SetTextFont(42);
  legend_9->Draw();


  //TCanvas *c10= new TCanvas("c10","Muon Momentum",600,500);
  //c9->Divide(2,1);

  //c10->cd(1);
  //TH1D h10 = h4_1*8;
  //h10.Draw("hist");
  //h10_1->SetTitle("Track Multiplicity; mult ;# of Events");
  //h10_1->Draw("hist");
  //Double_t j0 = 0.1809/h9->Integral();
  //h9->Scale(0.1809);
  //h10_1->SetLineColor(kRed);
  //h10_1->SetLineWidth(1);
  //h10_1->SetStats(kFALSE);
  //h10_1->GetYaxis()->SetTitleOffset(1.5);
