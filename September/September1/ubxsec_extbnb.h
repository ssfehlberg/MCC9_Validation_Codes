...
// Wed Sep  5 14:19:29 2018 by ROOT version 6.06/08
// from TTree tree/
// found on file: ubxsec_extbnb.root
//////////////////////////////////////////////////////////

#ifndef ubxsec_extbnb_h
#define ubxsec_extbnb_h
...
// I don't understand why this line is in here. Ask Lu!
//#include "UBXSecEvent.h"

//Branch located within TTree 
//#include "ubxsec_event_split"
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //UBXSecEvent     *ubxsec_event_split;
   ...
   ubxsec_extbnb(TTree *tree=0);
   virtual ~ubxsec_extbnb();
...
#ifdef ubxsec_extbnb_cxx
ubxsec_extbnb::ubxsec_extbnb(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ubxsec_extbnb.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ubxsec_extbnb.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ubxsec_extbnb.root:/UBXSec");
...
ubxsec_extbnb::~ubxsec_extbnb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ubxsec_extbnb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ubxsec_extbnb::LoadTree(Long64_t entry)
{
...
void ubxsec_extbnb::Init(TTree *tree)
{
...
void ubxsec_extbnb::Show(Long64_t entry)
{
...
Int_t ubxsec_extbnb::Cut(Long64_t entry)
{
