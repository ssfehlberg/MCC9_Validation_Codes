...

{
  ...
  // All the things for the muon candidate: anything with _1 is data and _2 is ext_last
  TH1D *h1 = (TH1D*)f1->Get("h_truth_phi_muon_MC_last");
  TH1D *h2 = (TH1D*)f1->Get("h_cos_truth_theta_muon_MC_last");
  TH1D *h3 = (TH1D*)f1->Get("h_muon_length_MC_last");
  
  TH1D *h1_1 = (TH1D*)f2->Get("h_truth_phi_muon_bnb_last");
  TH1D *h2_1 = (TH1D*)f2->Get("h_cos_truth_theta_muon_bnb_last");
  TH1D *h3_1 = (TH1D*)f2->Get("h_muon_length_bnb_last");

  TH1D *h1_2 = (TH1D*)f3->Get("h_truth_phi_muon_ext_last");
  TH1D *h2_2 = (TH1D*)f3->Get("h_cos_truth_theta_muon_ext_last");
  TH1D *h3_2 = (TH1D*)f3->Get("h_muon_length_ext_last");

  //All the things for the x,y,z coordinates of the vertex
  TH1D *h4 = (TH1D*)f1->Get("h_vertex_x_MC_last");
  TH1D *h5 = (TH1D*)f1->Get("h_vertex_y_MC_last");
  TH1D *h6 = (TH1D*)f1->Get("h_vertex_z_MC_last");
  
  TH1D *h4_1 = (TH1D*)f2->Get("h_vertex_x_bnb_last");
  TH1D *h5_1 = (TH1D*)f2->Get("h_vertex_y_bnb_last");
  TH1D *h6_1 = (TH1D*)f2->Get("h_vertex_z_bnb_last");

  TH1D *h4_2 = (TH1D*)f3->Get("h_vertex_x_ext_last");
  TH1D *h5_2 = (TH1D*)f3->Get("h_vertex_y_ext_last");
  TH1D *h6_2 = (TH1D*)f3->Get("h_vertex_z_ext_last");

  //All the things for the multiplicity
  TH1D *h7 = (TH1D*)f1->Get("h_shower_MC_last");
  TH1D *h8 = (TH1D*)f1->Get("h_pfp_MC_last");
  TH1D *h9 = (TH1D*)f1->Get("h_track_MC_last");
  
  TH1D *h7_1 = (TH1D*)f2->Get("h_shower_bnb_last");
  TH1D *h8_1 = (TH1D*)f2->Get("h_pfp_bnb_last");
  TH1D *h9_1 = (TH1D*)f2->Get("h_track_bnb_last");

  TH1D *h7_2 = (TH1D*)f3->Get("h_shower_ext_last");
  TH1D *h8_2 = (TH1D*)f3->Get("h_pfp_ext_last");
  TH1D *h9_2 = (TH1D*)f3->Get("h_track_ext_last");
  ...
  h1->Draw("hist");
  //Double_t a0 = 0.1809/h1->Integral();
  //h1->Scale(0.1809);
  ...
  //h1_1->Draw("SAME");
  //Double_t a1 = 1722807.0/h1_1->Integral();
  //h1_1->Scale(1722807.0);
  //h1_1->SetLineColor(kBlue);
  //h1->SetLineWidth(1);

  //h1_2->Draw("SAME");
  //Double_t a2 = 0.635926/h1_2->Integral();
  //h1_2->Scale(0.635926);
  //h1_2->SetLineColor(kGreen+2);
  //h1->SetLineWidth(1);
  ...
  legend_1->AddEntry(h1,"MC_last");
  legend_1->AddEntry(h1_1,"BNB_LAST-EXT_LAST");
  //legend_1->AddEntry(h1_2,"EXT_LAST");
  ...
  h2->Draw("hist");
  //Double_t b0 = 0.1809/h2->Integral();
  //h2->Scale(0.1809);
  ...
  //h2_1->Draw("SAME");
  //Double_t b1 = 1722807.0/h2_1->Integral();
  //h2_1->Scale(1722807.0);
  //h2_1->SetLineColor(kBlue);
  //h2_1->SetLineWidth(1);
  
  //h2_2->Draw("SAME");
  //Double_t b2 = 0.635926/h2_2->Integral();
  //h2_2->Scale(0.635926);
  ...
  legend_2->AddEntry(h2,"MC_last");
  legend_2->AddEntry(h2_1,"BNB_LAST-EXT_LAST");
  //legend_2->AddEntry(h2_1,"EXT_LAST");
  ...
  legend_3->AddEntry(h3,"MC_last");
  legend_3->AddEntry(h3_1,"BNB_LAST-EXT_LAST");
  //legend_3->AddEntry(h3_2,"EXT_LAST");
  ...
  h4->Draw("hist");
  //Double_t d0 = 0.1809/h4->Integral();
  //h4->Scale(0.1809);
  ...
  //h4_1->SetLineWidth(1);
  //Double_t d1 = 1722807.0/h4_1->Integral();
  //h4_1->Scale(1722807.0);
  ...
  legend_4->AddEntry(h4,"MC_last");
  legend_4->AddEntry(h4_1,"BNB_LAST-EXT_LAST");
  //legend_4->AddEntry(h4_2,"EXT_LAST");
  ...
  legend_5->AddEntry(h5,"MC_last");
  legend_5->AddEntry(h5_1,"BNB_LAST-EXT_LAST");
  //legend_5->AddEntry(h5_2,"EXT_LAST");
  ...
  legend_6->AddEntry(h6,"MC_last");
  legend_6->AddEntry(h6_1,"BNB_LAST-EXT_LAST");
  //legend_6->AddEntry(h6_2,"EXT_LAST");
  ...
  legend_7->AddEntry(h7,"MC_last");
  legend_7->AddEntry(h7_1,"BNB_LAST-EXT_LAST");
  //legend_7->AddEntry(h7_2,"EXT_LAST");
  ...
  legend_8->AddEntry(h8,"MC_last");
  legend_8->AddEntry(h8_1,"BNB_LAST-EXT_LAST");
  //legend_8->AddEntry(h8_2,"EXT_LAST");
  ...
  legend_9->AddEntry(h9,"MC_last");
  legend_9->AddEntry(h9_1,"BNB_LAST-EXT_LAST");
  //legend_9->AddEntry(h9_2,"EXT_LAST");
